		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comwsllistapessoas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comwsllistapessoas-display": {
								"semanticObject": "comwsllistapessoas",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.wsl.listapessoas",
									"url": sap.ui.require.toUrl("com/wsl/listapessoas")
								}
							}
						}
					}
